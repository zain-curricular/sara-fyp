/**
 * Root workspace Next app (`src/app/api/*`) — **not** this mobile dev server unless you only run one app.
 *
 * - **Browser:** empty string → same-origin `/api/...` on the mobile app; `app/api/[[...path]]` proxies to
 ...
 * If the mobile app took port 3000, run the main app on **another port** and point this env there.
 */
