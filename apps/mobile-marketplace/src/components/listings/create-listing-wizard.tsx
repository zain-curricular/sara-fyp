...
//
// Desktop layout: form on the left, sticky live-preview card on the right.
// The preview updates in real-time from local state without any API call.
//
// API calls (create draft → upload images → publish) only fire on step
// transitions, so all draft data is local until the user clicks "Continue".
...
const CONDITIONS = [
	{ value: "new", grade: "A+", label: "New", sub: "Sealed in box" },
	{ value: "like_new", grade: "A", label: "Like New", sub: "Opened, unused" },
...
/** Multi-step listing creation form with live preview. */
	...
	return (
		<div container-id="create-listing-wizard" className="flex flex-col gap-6">
			...
			<div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_280px]">
							...
							<CardContent className="flex flex-col gap-4">
								<Field>
									...
									<Input
										...
										placeholder="e.g. iPhone 13 Pro · 256 GB · Graphite · Unlocked"
									/>
								</Field>
								<Field>
									...
									<Textarea
										...
										placeholder="Describe the phone's condition, what's included, any faults…"
										rows={4}
									/>
								</Field>
							</CardContent>
				...
				{step === 3 && listingId ? (
					<div container-id="wizard-step-publish" className="flex flex-col gap-5">
						<Card size="sm">
							...
							<CardContent className="flex flex-col gap-4">
								<p className="text-sm text-muted-foreground">
									Your listing will go live immediately and be visible to all buyers on the platform.
				...
				{/* Sticky preview — only on step 1 (form is filling in) */}
