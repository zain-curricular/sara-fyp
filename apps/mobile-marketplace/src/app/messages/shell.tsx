...
const MOCK_CONVOS: Conversation[] = [
	{
		...
		initials: "JK",
		handle: "julia_k",
		preview: "here — super minor, camera bump hides most of it",
		time: "2m",
	...
	},
	{
		...
		initials: "NO",
		handle: "nico_o",
		preview: "yes, battery is 94% · tested last week",
		time: "1h",
		item: "Pixel 8 · 128GB",
		price: "$310",
		status: "negotiating",
	...
	},
	{
		...
		initials: "RA",
		handle: "ra_2",
		preview: "shipped! tracking attached.",
		time: "Apr 14",
		item: "Galaxy S23 Ultra · 512GB",
		price: "$620",
		status: "shipped",
		unread: 0,
		orderId: "A-9388",
...
const MOCK_THREAD: Message[] = [
	{ id: "m1", from: "them", text: "hi! shipped the phone this morning. tracking DHL 4412-8821-00", time: "Apr 19 · 14:02" },
	{ id: "m2", from: "me", text: "thanks! quick question — how bad is the back scuff? can I see a photo?", time: "14:08" },
	{ id: "m3", from: "them", text: "here — super minor, camera bump hides most of it", time: "14:11" },
];
