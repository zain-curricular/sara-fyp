...
// Uses OtpInput (single styled field with large mono tracking) via react-hook-form
// Controller. Verifies via useOtpFlow().verifyPhoneOtp, then navigates to profile.
