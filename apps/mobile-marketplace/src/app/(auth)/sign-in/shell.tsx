...
// ============================================================================
//
// Centered card layout (Wireframe Variant A). Logo mark → "login" label →
// "welcome back" heading → email/password fields → "Sign in →" CTA → footer
// with forgot-password + sign-up links → "— or —" divider → disabled OAuth.
//
