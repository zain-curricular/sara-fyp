...
// ============================================================================
//
// Timeline-card style orders list (Wireframe Variant B). Each order is a
// horizontal card with image placeholder, status badge, seller handle, and
// a sub-line that surfaces the most actionable info (e.g. "tap to approve").
//
// Filter chips let the buyer narrow to "In escrow" or "Disputes". All data is
...
const MOCK_ORDERS: MockOrder[] = [
	{
		id: "A-9421",
		item: "iPhone 13 Pro · 256 GB · Graphite",
		seller: "@julia_k",
		price: "$501",
		status: "in_transit",
		sub: "Arriving Thursday · DHL 4412-8821-00",
	},
	{
		id: "A-9388",
		item: "Pixel 8",
	...
	},
	{
		...
		price: "$520",
		status: "completed",
		sub: "Done · warranty active for 6 months",
	},
	{
		id: "A-9144",
...
/** Buyer orders list — timeline card layout with filter chips. */
