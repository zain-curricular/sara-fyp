...
// ============================================================================
//
// Client shell for the part detail page. Two-column layout on desktop:
...
const CONDITION_CHECKS: Record<string, string[]> = {
	new: ["Original packaging intact", "OEM part number verified", "No installation marks", "Warranty seal present"],
	like_new: ["Removed from vehicle but unused", "OEM number confirmed", "No wear or corrosion"],
	excellent: ["Very light use", "Mechanically inspected and cleared", "Fitment compatibility checked"],
	good: ["Normal service wear", "All connections and seals intact", "Core functions verified by mechanic"],
	fair: ["Visible wear signs", "Some surface corrosion noted", "All primary functions working"],
	poor: ["Heavy wear and use", "Cosmetic damage present", "Verify condition before fitment"],
};

const FALLBACK_CHECKS = [
	"Mechanic inspected and cleared",
	"OEM compatibility verified",
	"Photos represent actual item",
];
				...
				<div container-id="listing-detail-main" className="flex min-w-0 flex-col gap-6">
					...
					<Card size="sm">
						<CardHeader>
							...
							<CardAction>
								<Badge variant="secondary" className="rounded-sm text-[10px]">INSPECTED</Badge>
							</CardAction>
						</CardHeader>
						<CardContent>
