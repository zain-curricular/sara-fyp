...
// ============================================================================
//
// Analytics-forward seller overview. All figures are static placeholders —
// no analytics API exists yet. Shows KPI cards, weekly revenue bar chart,
// top-listings table, conversion funnel, and a "needs action" task list.
...
const MOCK_STATS = [
	{ label: "Revenue", value: "Rs 248,000", delta: "+18% vs last month", up: true },
...
const MOCK_TOP_LISTINGS = [
	{ title: "Alternator · Toyota Corolla", sold: 12, revenue: "Rs 150,000" },
	{ title: "Brake Discs Set · Honda Civic", sold: 8, revenue: "Rs 65,600" },
	{ title: "Radiator Fan · Suzuki Cultus", sold: 6, revenue: "Rs 21,600" },
	{ title: "Starter Motor · Mehran", sold: 4, revenue: "Rs 11,200" },
];
...
export default function SellerShell() {
	return (
		<div container-id="seller-shell" className="flex flex-col gap-6">
			...
			<header container-id="seller-header" className="flex flex-wrap items-start justify-between gap-3">
			...
			<div container-id="seller-charts" className="grid grid-cols-1 gap-4 lg:grid-cols-2">
				<RevenueBarChart />
				<TopListings />
			</div>

			<div container-id="seller-lower" className="grid grid-cols-1 gap-4 lg:grid-cols-2">
				<ConversionFunnel />
				<NeedsAction />
			</div>

			<div container-id="seller-quick-links" className="flex flex-wrap gap-2">
				<Link href="/seller/listings" className={buttonVariants({ variant: "outline", size: "sm" })}>
					<BarChart3 className="size-3.5" aria-hidden />
					My listings
				</Link>
				<Link href="/seller/listings/new" className={buttonVariants({ variant: "ghost", size: "sm" })}>
