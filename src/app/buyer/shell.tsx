...
// ============================================================================
//
// Activity-first home base after login. Shows live bids on parts, orders in
// transit, watching count, ending-soon auction table, and a recently viewed
// mini-grid. All figures are placeholder — no bids/orders API yet.
//
...
const MOCK_AUCTIONS = [
	{ name: "Alternator · Toyota Corolla", price: "Rs 12,500", status: "leading", endsIn: "3m" },
	{ name: "Brake Discs Set · Honda Civic", price: "Rs 8,200", status: "outbid", endsIn: "42m" },
	{ name: "Head Gasket · Suzuki Mehran", price: "Rs 3,800", status: "leading", endsIn: "2h" },
] as const;

const MOCK_VIEWED = [
	{ name: "Radiator Fan · Corolla", price: "Rs 4,500" },
	{ name: "Starter Motor · Cultus", price: "Rs 6,200" },
	{ name: "Shock Absorber Set", price: "Rs 9,800" },
	{ name: "Engine Mount · Civic", price: "Rs 3,100" },
];
		...
		<div container-id="buyer-shell" className="flex flex-col gap-6">
			...
			<div container-id="buyer-stats" className="grid grid-cols-1 gap-3 sm:grid-cols-3">
				<ActivityCard
					...
					label="active bids"
					value="3"
					sub="leading: Alternator · Rs 12,500"
					href="/buyer/orders"
					cta="Go to bids →"
					highlight
				/>
