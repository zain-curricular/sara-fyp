...
import { getListingForOwner, listAutomotiveCategories } from "@/lib/features/listings/services";
...
export default async function EditListingPage({
	...
	const { data: categories, error: catErr } = await listAutomotiveCategories();
	if (catErr) {
