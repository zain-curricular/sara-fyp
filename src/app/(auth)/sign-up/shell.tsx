...
// ============================================================================
//
// Split-screen layout. Left pane — form: logo, "signup · step 1 of 3",
// "Join thousands of buyers", email + password + confirm, "Create account →",
// — or — divider, disabled OAuth, "Already have an account? Log in".
// Right pane — orange-tinted trust panel: "why automart" label, headline,
// three feature cards (Verified / Escrow / Warranty), testimonial.
...
const TRUST_FEATURES = [
	{
		...
		body: "Every listing is checked for authenticity and compatibility before going live.",
	},
	{
		icon: "🔒",
		title: "Escrow protection",
		body: "Payment is held securely until you confirm the part is correct.",
	},
	{
		icon: "🛡",
		...
		>
			...
			<div container-id="sign-up-form-pane" className="flex flex-col gap-5 p-6 sm:p-8 lg:p-10">
				...
				<div className="flex flex-col gap-1">
					...
					<h1 className="text-2xl font-bold tracking-tight">Join thousands of buyers</h1>
				</div>
			...
			>
				...
				<h2 className="text-xl font-bold leading-snug tracking-tight">
					Parts you can<br />actually trust.
				</h2>
				...
				<blockquote className="flex flex-col gap-2 rounded-xl border border-primary/20 bg-primary/[0.06] p-4">
					<p className="text-sm leading-relaxed text-foreground/80">
						"Finding the right part used to take hours. automart made it simple."
					</p>
