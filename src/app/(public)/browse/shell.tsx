...
// ============================================================================
//
// Entry to the catalog hierarchy: Brand → Model → Parts.
			...
			<header container-id="browse-header" className="flex flex-col gap-4">
				<div className="flex flex-col gap-1">
					...
					<p className="text-sm text-muted-foreground">
						{brands.length} brand{brands.length !== 1 ? "s" : ""} · pick one to explore models and parts.
					</p>
				</div>
				...
				>
					...
					Search across all parts and brands…
				</Link>
			</header>
